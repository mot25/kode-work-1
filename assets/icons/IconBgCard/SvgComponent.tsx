...
const SvgComponent = () => (
    <Svg width={43} height={35} fill="none" >
        <Rect width={43} height={35} rx={4} fill={darkTheme.palette.content.secondary} />
        <Mask
            id="a"
            style={{
                maskType: "alpha",
            ...
            height={35}
        >
            <Rect width={43} height={35} rx={3} fill={darkTheme.palette.accent.tertiary} />
        </Mask>
        ...
        <G mask="url(#a)">
            <Path
                ...
                fill={darkTheme.palette.helpers.icon_bg_card}
            />
        </G>
    </Svg>
)
