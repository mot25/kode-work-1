...
import { TReqDtoGetCodeOpt, TResponseCodeOpt } from '../config/types';
import { $mobileNuber, resetMobileNumber, sendMobileNumber, setCodeOpt, setMobileNumber } from '../model/stateAuthNumber';
import { InputAuthNumber } from './molecules/InputAuthNumber';
