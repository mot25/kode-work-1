...
import { TResponseCodeOpt } from 'pages /AuthNumber/config/types';
import { $codeOpt, $mobileNuber } from 'pages /AuthNumber/model/stateAuthNumber';
import { TSetAttemptsLeft } from 'pages /CodeAcces/config/types';
