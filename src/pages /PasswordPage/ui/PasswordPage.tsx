...
import { TReqDtoAuth, TResponseAuth } from 'pages /AuthNumber/config/types';
import { $codeOpt, resetMobileNumber } from 'pages /AuthNumber/model/stateAuthNumber';
...
import {
    ...
    authPasswordFx,
    setFPasswordAuth,
} from 'pages /PasswordPage/model/statePasswordPage';
